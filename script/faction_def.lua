...
--      },
    [tbFacDef.tbIds.SHAOLIN] = {-- ÉÙÁÖ
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {318, 1, "QuyÒn ph¸p", "§¹t Ma §é Giang"},   -- ´ïÄ¦¶É½­[318]            Ìí¼ÓÊìÁ·¶È¼¼ÄÜ ÖÁÉÙÌí¼ÓÎª1¼¶
                {319, 1, "C«n ph¸p", "Hoµnh T¶o Thiªn Qu©n"},   -- ºáÉ¨Ç§¾ü[319]£¨90¼¶£©
                {321, 1, "§ao ph¸p", "V« T­íng Tr¶m "},     -- ÎÞÏàÕ¶  [321]£¨90¼¶£©
            },
            [120]   = {
                {709, 1, "Th«ng dông", "§¹i Thõa Nh­ Lai Chó"}
            },
            [150]   = {
                {1055, 1, "QuyÒn ph¸p", "§¹i Lùc Kim Cang Ch­ëng"},  -- ´óÁ¦½ð¸ÕÕÆ[318]          Ìí¼ÓÊìÁ·¶È¼¼ÄÜ ÖÁÉÙÌí¼ÓÎª1¼¶
        ...
        {
            tbSkillBook90 = {
                {"ThiÕu L©m QuyÒn Ph¸p. QuyÓn 1",56},
                {"ThiÕu L©m C«n ph¸p. QuyÓn 2",57},
    ...
    [tbFacDef.tbIds.TIANWANG] = {-- ÌìÍõ
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {325, 1, "Chïy ph¸p", "Truy Phong QuyÕt "},     -- ×··ç¾÷  £¨90¼¶£©
                {323, 1, "Th­¬ng ph¸p", "Truy Tinh Trôc NguyÖt "},   -- ×·ÐÇÖðÔÂ£¨90¼¶£©
                {322, 1, "§ao ph¸p", "Ph¸ Thiªn Tr¶m "},     -- ÆÆÌìÕ¶  £¨90¼¶£©
            },
            [120]   = {
                {708, 1, "Th«ng dông", "§¶o H­ Thiªn"}    --
            },
            [150]   = {
                {1059, 1, "Chïy ph¸p", "Tung Hoµnh B¸t Hoang"},  -- ×Ýºá°Ë»Ä
        ...
        {
            tbSkillBook90 = {
                {"Thiªn V­¬ng Chïy Ph¸p. QuyÓn 1",37},
                {"Thiªn V­¬ng Th­¬ng ph¸p. QuyÓn 2",38},
                {"Thiªn V­¬ng §ao ph¸p.QuyÓn 3",39}
            },
        },
    },
    ...
    [tbFacDef.tbIds.TANGMEN] = {-- ÌÆÃÅ
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {339, 1, "Phi ®ao", "NhiÕp Hån NguyÖt ¶nh"},   -- Éã»êÔÂÓ°[339]£¨90¼¶£©
            ...
            [120]   = {
                {710, 1, "Th«ng dông", "Mª ¶nh Tung"}
            },
            [150]   = {
                {1069, 1, "Phi ®ao", "V« ¶nh Xuyªn"},     -- ÎÞÓ°´©
        ...
        {
            tbSkillBook90 = {
                {"Phi §ao thuËt. NhiÕp Hån NguyÖt ¶nh",45},
                {"Tô TiÔn thuËt. B¹o Vò Lª Hoa",27},
                {"Phi Tiªu thuËt. Cöu Cung Phi Tinh",46},
    ...
    [tbFacDef.tbIds.WUDU] = {-- Îå¶¾
        ...
        {
            tbSkillBook90 = {
                {"Ngò §éc Ch­ëng Ph¸p. QuyÓn 1",47},
                {"Ngò §éc §ao ph¸p. QuyÓn 2",48},
    ...
    [tbFacDef.tbIds.EMEI] = {-- ¶ëÃ¼
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {328, 1, "KiÕm ph¸p", "Tam Nga TÒ TuyÕt "},   -- Èý¶ëö«Ñ©[328]£¨90¼¶£©
                {380, 1, "Ch­ëng ph¸p", "Phong S­¬ng To¸i ¶nh "},   -- ·çËªËéÓ°[380]£¨90¼¶£©
                {332, 0, "Th«ng dông", "Phæ §é Chóng Sinh "},   -- ÆÕ¶ÉÖÚÉú[332]£¨90¼¶£©
            },
            [120]   = {
                {712, 1, "Th«ng dông", "BÕ NguyÖt PhÊt TrÇn"}
            },
            [150]   = {
                {1061, 1, "KiÕm ph¸p", "KiÕm Hoa V·n Tinh"},  -- ½£»¨Íì¾§
        ...
        {
            tbSkillBook90 = {
                {"DiÖt KiÕm MËt TÞch",42},
                {"Nga Mi  PhËt Quang Ch­ëng MËt TÞch",43},
                {"Phæ §é MËt TÞch",59}
            },
        },
    },
    ...
    [tbFacDef.tbIds.CUIYAN] = {-- ´äÑÌ
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {336, 1, "§ao ph¸p", "B¨ng Tung V« ¶nh "},   -- ±ù×ÙÎÞÓ°[336]£¨90¼¶£©
                {337, 1, "Song ®ao", "B¨ng T©m Tiªn Tö  "},   -- ±ùÐÄÏÉ×Ó[337]£¨90¼¶£©
            },
            [120]   = {
                {713, 1, "Th«ng dông", "Ngù TuyÕt Èn"}
            },
            [150]   = {
                {1063, 1, "§ao ph¸p", "B¨ng T­íc Ho¹t Kú"},  -- ±ùÈ¸Ô½Ö¦
    ...
    [tbFacDef.tbIds.GAIBANG] = {-- Ø¤°ï
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {357, 1, "Ch­ëng ph¸p", "Phi Long T¹i Thiªn "},   -- ·ÉÁúÔÚÌì[357]£¨90¼¶£©
                {359, 1, "Bæng ph¸p", "Thiªn H¹ V« CÈu "},   -- ÌìÏÂÎÞ¹·[359]£¨90¼¶£©
            },
            [120]   = {
                {714, 1, "Th«ng dông", "Hçn Thiªn KhÝ C«ng"}
            },
            [150]   = {
                {1073, 1, "Ch­ëng ph¸p", "Thêi ThÆng Lôc Long"},  -- Ê±³ËÁùÁú
        ...
        {
            tbSkillBook90 = {
                {"C¸i Bang ch­ëng ph¸p",54},
                {"C¸i Bang c«n ph¸p",55}
            },
        },
    },
    ...
    [tbFacDef.tbIds.TIANREN] = {-- ÌìÈÌ
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {361, 1, "Th­¬ng ph¸p", "V©n Long KÝch"},     -- ÔÆÁú»÷  [361]£¨90¼¶£©
                {362, 1, "§ao ph¸p", "Thiªn Ngo¹i L­u Tinh"},   -- ÌìÍâÁ÷ÐÇ[362]£¨90¼¶£©
                {391, 0, "Th«ng dông", "NhiÕp Hån Lo¹n T©m "},   -- Éå»êÂÒÐÄ[391]£¨90¼¶£©
            },
            [120]   = {
                {715, 1, "Th«ng dông", "Ma ¢m PhÖ Ph¸ch"}
            },
            [150]   = {
                {1075, 1, "Th­¬ng ph¸p", "Giang H¶i Né Lan"},  -- ½­º£Å­À½
    ...
    [tbFacDef.tbIds.WUDANG] = {-- Îäµ±
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {365, 1, "QuyÒn ph¸p", "Thiªn §Þa V« Cùc "},   -- ÌìµØÎÞ¼«[365]£¨90¼¶£©
                {368, 1, "KiÕm ph¸p", "Nh©n KiÕm Hîp NhÊt  "},   -- ÈË½£ºÏÒ»[368]£¨90¼¶£©
            },
            [120]   = {
                {716, 1, "Th«ng dông", "XuÊt ø BÊt NhiÔm"}
            },
            [150]   = {
                {1078, 1, "QuyÒn ph¸p", "T¹o Hãa Th¸i Thanh"},  -- Ôì»¯Ì«Çå
        ...
        {
            tbSkillBook90 = {
                {"Th¸i Cùc QuyÒn Phæ. QuyÓn 3",33},
                {"Th¸i Cùc KiÕm Phæ. QuyÓn 2",34}
            },
        },
    },
    ...
    [tbFacDef.tbIds.KUNLUN] = {-- À¥ÂØ
        ...
        tbSkillID       =
        {
            ...
            [90]    = {
                {372, 1, "§ao ph¸p", "Ng¹o TuyÕt Tiªu Phong "},   -- °ÁÑ©Ð¥·ç[372]£¨90¼¶£©
                {375, 1, "KiÕm ph¸p", "L«i ®éng Cöu Thiªn "},   -- À×¶¯¾ÅÌì[375]£¨90¼¶£©
                {394, 0, "Th«ng dông", "Tóy Tiªn T¸ Cèt"},   -- ×íÏÉ´í¹Ç[394]£¨90¼¶£©
            },
            [120]   = {
                {717, 1, "Th«ng dông", "L­ìng Nghi Ch©n KhÝ"}
            },
            [150]   = {
                {1080, 1, "§ao ph¸p", "Cöu Thiªn C­¬ng Phong"},  -- ¾ÅÌìî¸·ç
    ...
    [tbFacDef.tbIds.HUASHAN] = {-- »ªÉ½
        ...
        tbSkillID       =
        {
            ...
            [90] = {
                {1364, 1, "Hoa S¬n kiÕm t«ng", "§o¹t MÖnh Liªn Hoµn Tam Tiªn KiÕm"},  -- ¶áÃüÁ¬»·ÈýÏÉ½£(90¼¶)
                {1382, 1, "Hoa S¬n khÝ t«ng", "Ph¸ch Th¹ch Ph¸ Ngäc"},       -- ÅüÊ¯ÆÆÓñ(90¼¶)
            },
            [120] = {
                {1365, 1, "Th«ng dông", "Tö Hµ KiÕm KhÝ"}                   -- ×ÏÏ¼½£Æø(120¼¶)
            },
            [150] = {
                {1369, 1, "Hoa S¬n kiÕm t«ng", "Cöu kiÕm hîp nhÊt"},  -- ¾Å½£ºÏÒ»
        ...
        {
            tbSkillBook90 = {
                {"Hoa S¬n KiÕm T«ng-§o¹t mÖnh liªn hoµn tam tiªn kiÕm", 4062},
    ...
    [tbFacDef.tbIds.WUHUN] = {-- Îä»ê
        ...
        tbSkillID       =
        {
            ...
            [90] = {
                {1967, 1, "Vò Hån hÖ ThuÉn", "TrÊn Biªn Thïy"},  -- Õò±ßÚï(90¼¶)
                {1983, 1, "Vò Hån hÖ §ao", "Kh¸t Èm Hung N« HuyÕt"},  -- ¿ÊÒûÐÙÅ«Ñª(90¼¶)
            },
            [120] = {
                {1984, 1, "Th«ng dông", "Trung Vu L­u Phong"}                   -- ÖÒÎäÁ÷·ç(120¼¶)
            },
            [150] = {
                {1969, 1, "Vò Hån hÖ ThuÉn", "Huy S­ DiÖt Lç"},  -- »ÓÊ¦ÃðÂ²
        ...
        tbItemInfo      =
        {
            tbSkillBook90 = {   -- 90¼¶¼¼ÄÜÊéµÀ¾ßÃûºÍID,×¢Òâ£¡ÒªºÍ¼¼ÄÜ±íÖÐ90¼¶¼¼ÄÜµÄË³ÐòÒ»Ò»¶ÔÓ¦£¡
                {"Vò Hån ThuÉn Ph¸p#TrÊn Biªn Thïy",5106},
                {"Vò Hån §ao Ph¸p#Kh¸t Èm Hung N« HuyÕt",5107},
            },
        },
    },
    [tbFacDef.tbIds.XIAOYAO] = {-- åÐÒ£ÅÉ
        ...
        {
            [10] = {
                1881,   -- Îâ¹³ËªÑ©(ÈëÃÅ) Ng« C©u S­¬ng TuyÕt
                1905,   -- ËæÒâÇú(ÈëÃÅ) Tïy ý Khóc
            },
            [20] = {
                1882,   -- åÐÒ£½£·¨(10¼¶) Tiªu Dao KiÕm Ph¸p
                1906,   -- åÐÒ£ÇÙ·¨(10¼¶) Tiªu Dao CÇm Ph¸p
            },
            [30] = {
                1883,   -- ÒÆ¹¬»»Óð(20¼¶) Di Cung Ho¸n Vò
            },
            [40] = {
                1885,   -- ìªí³Á÷ÐÇ(30¼¶) T¸p §¹p L­u Tinh
                1907,   -- ÂäÑãÆ½É³(30¼¶) L¹c Nh¹n B×nh Sa
            },
            [50] = {
                1887,   -- ÒÐ½£·÷Ìì(40¼¶) û KiÕm PhÊt Thiªn
                1909,   -- ¹ãÁêÉ¢(40¼¶) Qu¶ng L¨ng T¸n
            },
            [60] = {
                1888,   -- Òø°°°×Âí(50¼¶) Ng©n Yªn B¹ch M·
            },
            [70] = {
                1890,   -- Ç§Àï¶ÀÐÐ(ÕòÅÉ) Thiªn Lý §éc Hµnh
                1889,   -- ÏÀ¹ÇÈáÇé(³öÊ¦) HiÖp Cèt Nhu T×nh --tq
            },
            [90] = {
                {1891, 1, "Tiªu Dao KiÕm T«ng", "KiÕm QuyÕt Phï V©n"},  -- ½£¾ö¸¡ÔÆ(90¼¶)
                {1910, 1, "Tiªu Dao CÇm T«ng", "Cao S¬n L­u Thñy "},  -- ¸ßÉ½Á÷Ë®(90¼¶)
            },
            [120] = {
                {1894, 1, "Th«ng dông", "¡n Uèng No Say"}                   -- à¢ÖË³Öõü(120¼¶)
            },
            [150] = {
                {1896, 1, "Tiªu Dao KiÕm T«ng", "ThËp Bé NhÊt S¸t"},  -- Ê®²½Ò»É±
        ...
        {
            tbSkillBook90 = {   -- 90¼¶¼¼ÄÜÊéµÀ¾ßÃûºÍID,×¢Òâ£¡ÒªºÍ¼¼ÄÜ±íÖÐ90¼¶¼¼ÄÜµÄË³ÐòÒ»Ò»¶ÔÓ¦£¡
                {"Tiªu Dao KiÕm Ph¸p-KiÕm QuyÕt Phï V©n",5231},
                {"Tiªu Dao CÇm Ph¸p-Cao S¬n L­u Thñy",5232},
            },
            tbVipMaskIndex = {
                [1] = 8767, -- Äù˜„¡¤Ñ×»ËÃæ¾ß
                [2] = 8768, -- ÎÞ¾¡¡¤Ñ×»ËÃæ¾ß
