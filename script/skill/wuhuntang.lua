...
SKILLS={
	...
	gongzhongbingxing={ --¹«ÖÒ±üÐÔ
        ...
        autocastskill = {
			...
			{{1, (3*18*256 + 100)},{20, (3*18*256 + 100)}},-- ¼ä¸ôÖ¡Êý * 256 + ·¢¶¯¼¸ÂÊ
		},
        special_point_base={
	...
	nuqi2={ --¹«ÖÒ±üÐÔ-Å­2£¨±»¶¯£©
		special_point_add={
			...
			{{1,-1},{20,-1}},-- ÅäÔÚÖ÷¶¯¼¼ÄÜÊôÐÔÉÏÌî0£¬×÷ÎªbuffÊôÐÔÌî-1
			{{1,4 * 256},{20,4 * 256}},-- ×î´ó¸öÊý*256 + Ôö¼Ó¸öÊý
		}
	},
	hanshanji={ --º³É½»÷
	...
	wumuyizhi={ --ÎäÄÂÒÅÖ¾
		lock_life={
			{{1,100},{35,3000},{36,3400}}, -- Ëø¶¨µÄÊýÖµ
			{{1,18*1},{20,18*3},{30,18*4},{41,18*4}}, -- ³ÖÐøÊ±¼ä£¬ÒÔbuffµÄµÚÒ»¸öÊôÐÔÎª×¼
			{{1,1},{20,1,}},-- 0£ºÎÞÐ§¹û£¬ 1£º²»ÄÜµÍÓÚËø¶¨Öµ£¬ 2£º²»ÄÜ¸ßÓÚËø¶¨Öµ£¬3£ºÖ»ÄÜµÈÓÚËø¶¨Öµ
		},
	...
	zhongwuliufengBUFF={ --ÖÒÎäÁ÷·ç»ØÑªBUFF
		resume_life_p = {
			{{1,30},{28,60},{34,70},{35,71}}, -- »Ø°Ù·ÖÖ®¼¸,¸ºÊýÎÞÐ§
			{{1,1},{2,1}} -- ³ÖÐøÊ±¼ä£¬Ã¿Ö¡ÉúÐ§
		},
	},
	chanjianchuning={ --²ù¼é³ýØú
		...
		skill_desc=
			function(level)
				return "Sau khi ®èi ph­¬ng tróng ®ßn <color=yellow>Trõ Gian DiÖt NÞnh<color>, nÕu ®èi ph­¬ng ®· cã <color=orange>tr¹ng th¸i bÊt lîi Lay S¬n KÝch<color> sÏ t¹o l¹i thêi gian duy tr× tr¹ng th¸i nµy\n\n"
			end,
	...
	wuhuntang_dunfa={ --Îä»êÌÃ¶Ü·¨
		...
		attackratingenhance_p={{{1,20},{20,320}},{{1,-1},{2,-1}}},--Ôö¼ÓÃüÖÐÂÊ LLX140722
...
--		skill_showevent={{{1,0},{10,0},{10,1},{20,1}}},
	...
	qingyin_tiruilv1={ --ÇëÓ§ÌáÈñÂÃ
		...
		--skill_desc=
			--function(level)
				...
				--return format("Òý±¬Æø³¡Ôì³É<color=orange>%d<color>µãµÄ±ùÊôÐÔÉËº¦£¬²¢Ê¹µÐÈË¶¨Éí<color=orange>%.2f<color>Ãë£¬\n", nMag, nPois)
			--end,
		addskilldamage1={
				[1]={{1,1382},{2,1382}},
				[3]={{1,1},{20,60},{31,70}}
	...
	huishi_mielu={ --»ÓÊ¦ÃðÂ²
		...
		missle_speed_v={{{1,55},{20,55},{21,55}}},--Ôö¼Óµ¶´äÑÌµÄ×Óµ¯·ÉÐÐËÙ¶È ByLLX 140722
...
--		skill_cost_v={{{1,30},{20,35}}}
	zhiyong_new1={ --ÖÇÓÂ³¬Â×Ö÷¶¯
		...
		skill_desc=
			function(level)
				return "<color=water>[ChiÕt KÝch]<color> g©y cho ng­êi tÊn c«ng, kü n¨ng tÊn c«ng t¨ng: Gi¶m <color=orange>"..floor(-Link(level,SKILLS.zhiyong_chaolun1.skill_enhance[1]))..
