...
function dialog_chuyensinh_main()
	local szTitle = "Xin chµo ! ßπi hi÷p muËn chuy”n sinh ?<enter><enter>Chuy”n sinh l«n <color=yellow>"..(GetTask(5100)+1).."<color> c«n :<enter>- ßºng c p : <color=yellow>"..regLevel.."<color> <enter>- Ti“n : <color=yellow>"..regMoneyDesc.."<color> vπn"
	local tbOpt=
	{
	{"Chuy”n sinh",chuyensinh},
	{"T»y TÒy",clear_attibute_point},
	{"CÈng Æi”m nhanh",add_prop},
	{"H‰c Khinh C´ng",khinhcong},
	{"K’t thÛc ÆËi thoπi"},
	}
...
function clear_attibute_point()
	local szTitle = "Xin chµo <color=yellow>"..GetName().."<color>. Bπn c«n t»y Æi”m Ti“m N®ng hay K¸ N®ng?"
	local tbOpt =
	{
	{"T»y ßi”m K¸ N®ng.",DoClearSkill},
	{"T»y ßi”m Ti“m N®ng.",DoClearProp},
	{"TrÎ V“",dialog_hotro_main},
	{"Tho∏t."}
	}
	CreateNewSayEx("<npc>"..szTitle.."", tbOpt)
end
